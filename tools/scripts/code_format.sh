...
astyle="${astyle_bin} --options=${astyle_options} -n -v -z1 ${base_dir}/src/*.cc ${base_dir}/src/base_module/fp_log/*.cc ${base_dir}/src/common/*.h ${base_dir}/src/base_module/fp_log/*.h"
